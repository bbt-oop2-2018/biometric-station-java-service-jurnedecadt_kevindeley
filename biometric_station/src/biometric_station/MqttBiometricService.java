...
public class MqttBiometricService implements MqttCallback {
    ...
    private final String BASE_TOPIC = "oop2/biometricstation";
    private String channelName;
    private String channelTopic;
    
    public MqttBiometricService(String clientId, String channelName) {
    ...
    public void sendMessage(String message) {
        try {
            ...
            Logger.getLogger(MqttBiometricService.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
